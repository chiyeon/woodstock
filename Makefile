...
EMCC_ARGS=-sALLOW_MEMORY_GROWTH -O3 -s TOTAL_STACK=4MB -s ASSERTIONS=2 --shell-file src/web/index.html -s MODULARIZE -s WASM=1 -s EXPORT_NAME="WoodstockModule" -s EXPORTED_RUNTIME_METHODS='["ccall", "stringToUTF8"]' -s EXPORTED_FUNCTIONS='["_malloc", "_free"]' -s TOTAL_MEMORY='40MB'
