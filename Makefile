...
EMCC_ARGS=-O3 -s STACK_SIZE=128MB -s ASSERTIONS=2 --shell-file src/web/index.html -s MODULARIZE -s WASM=1 -s EXPORT_NAME="WoodstockModule" -s EXPORTED_RUNTIME_METHODS='["ccall", "stringToUTF8", "UTF8ToString"]' -s EXPORTED_FUNCTIONS='["_malloc", "_free", "_main"]' -s TOTAL_MEMORY=512MB -s ALLOW_MEMORY_GROWTH
