...
struct Bitboards
{
    ...
    const static Bitboard A_FILE                                = 0b1000000010000000100000001000000010000000100000001000000010000000;
    const static Bitboard H_FILE                                = 0b0000000100000001000000010000000100000001000000010000000100000001;
    const static Bitboard AB_FILE                               = 0b1100000011000000110000001100000011000000110000001100000011000000;
    const static Bitboard GH_FILE                               = 0b0000001100000011000000110000001100000011000000110000001100000011;
    const static Bitboard NOT_A_FILE                            = 0b0111111101111111011111110111111101111111011111110111111101111111;
    const static Bitboard NOT_H_FILE                            = 0b1111111011111110111111101111111011111110111111101111111011111110;
    const static Bitboard NOT_AB_FILE                           = 0b0011111100111111001111110011111100111111001111110011111100111111;
    const static Bitboard NOT_GH_FILE                           = 0b1111110011111100111111001111110011111100111111001111110011111100;
    const static Bitboard ROW_1                                 = 0b11111111;
    const static Bitboard ROW_8                                 = 0b1111111100000000000000000000000000000000000000000000000000000000;
    const static Bitboard NOT_ROW_1                             = 0b1111111111111111111111111111111111111111111111111111111100000000;
    const static Bitboard NOT_ROW_8                             = 0b0000000011111111111111111111111111111111111111111111111111111111;
